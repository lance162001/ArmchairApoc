...
class Sniper():
	def __init__(self):
		...
		self.opacity=0
		self.beam_surface=pygame.Surface((500,50))
	...
	def shoot(self):
		...
		if int(self.opacity) == 256:
			self.beam_surface.fill((255,0,0))
			self.opacity=0
		else:
			self.beam_surface.fill((0,255,255))
		if self.direction == "l":
			self.beam=screen.blit(self.beam_surface,(0,self.y))
		elif self.direction == "r":
			self.beam=screen.blit(self.beam_surface,(screen_x,self.y))
		elif self.direction == "u":
			self.beam=screen.blit(self.beam_surface,(self.x,0))
		else:
			self.beam=screen.blit(self.beam_surface,(self.x,screen_y))
...
invul_backround = get_image('background2.png')
invul_backround=pygame.transform.scale(invul_backround,(screen_x,screen_y))
...
while not done:
	...
	if game_over != True and not done:
	...
	if invul == True and game_over == False:
		Invul_timer+=1
		screen.blit(invul_backround,(0,0))
		if Invul_timer > 120:
			Invul_timer=0
			invul=False
	for enemy in Enemies:
